    ...
    <div className="min-h-screen" style={{
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Gestion budget intelligente avec IA pr�dictive
          </h1>
          
          <p className="text-lg md:text-xl text-white/90 mb-12 max-w-3xl mx-auto">
            Experience the future of financial with our innovative platform.
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-white mb-4">
              Analyse automatique des d�penses
            </h3>
      ...
      <footer className="container mx-auto px-4 py-12 text-center border-t border-white/10">
        <p className="text-white/60">
          © 2024 SmartBudget. Built with Go To Factory.
        </p>
      </footer>
    </div>
  )
